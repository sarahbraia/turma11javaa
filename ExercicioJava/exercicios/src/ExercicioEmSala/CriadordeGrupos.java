...
public class CriadordeGrupos {

	public static void main(String[] args) {
				Random sr = new Random();
				Scanner leia = new Scanner(System.in);
				
				String lista[] = {"Bruna dos Santos",
						...
						if (resposta == 'S' || resposta == 's')
						{
							...
							for (x = 0 ; x < LIMITE; x+=pessoas)
							{
								for ( y = 0; y < pessoas;y++)
								{
									...
									if (contador < LIMITE-sobrou2){
										imprima = randomiza[contador];
										System.out.println ("matricula:"+(imprima+1)+"\tgrupo : "+grupo+"\t Alunx: "+lista[imprima]);
								...
								if (sobro >0  ) {
										imprima = randomiza[LIMITE-sobro];
										System.out.println ("matricula:"+(imprima+1)+"\tgrupo : "+grupo+"\t Alunx: "+lista[imprima]);	
										sobro--;
								}
